...
var LDAvis = function(to_select, data_or_file_name) {
    ...
    // Assign the UI labels
    var mdsTitle = 'Intertopic Distance Map (via multidimensional scaling)'
    // The ones below should be in lower case
    var selectionLabel = 'topic'
    var barUnitSingular = 'term'
    var barUnitPlural = 'terms'
    var PCLabel = 'tokens'
    
    var selectionLabelUpper = selectionLabel.charAt(0).toUpperCase() + selectionLabel.slice(1)
    ...
    function visualize(data) {
        ...
        d3.select("#" + leftPanelID).append("text")
            ...
            .text("Marginal " + selectionLabel + " distribtion");
        d3.select("#" + leftPanelID).append("text")
            .attr("x", cx2 + 10)
        ...
        d3.select("#" + barFreqsID).append("text")
            ...
            .text("Overall " + barUnitSingular.toLowerCase() + " frequency");
        ...
        d3.select("#" + barFreqsID).append("text")
            ...
            .style("dominant-baseline", "middle")
            .text("Estimated " + barUnitSingular.toLowerCase() + " frequency within the selected " + selectionLabel);
        ...
        d3.select("#" + barFreqsID)
            ...
            .style("dominant-baseline", "middle")
            .text("For saliency, see Chuang et. al (2012).");
        d3.select("#" + barFreqsID)
            .append("a")
            ...
            .style("dominant-baseline", "middle")
            .text("For relevance, see Sievert & Shirley (2014).");
        ...
        var title = chart.append("text")
                ...
                .style("text-anchor", "middle")
                .style("font-size", "16px")
                .text("Top-" + R + " Most Salient " + barUnitPlural.charAt(0).toUpperCase() + barUnitPlural.slice(1));
        ...
        function init_forms(topicID, lambdaID, visID) {
            ...
            topicLabel.innerHTML = "Selected " + selectionLabelUpper + ": <span id='" + topicID + "-value'></span>";
        ...
        function topic_on(circle) {
            ...
            d3.select("#" + barFreqsID)
                ...
                .style("text-anchor", "middle")
                .style("font-size", "16px")
                .text("Top-" + R + " Most Relevant " + barUnitPlural.charAt(0).toUpperCase() + barUnitPlural.slice(1) + " for "+ selectionLabelUpper + " " + topics + " (" + Freq + "% of " + PCLabel + ")");
        ...
        function topic_off(circle) {
            ...
            var title = d3.selectAll(to_select + " .bubble-tool")
                    .text("Top-" + R + " Most Salient " + barUnitPlural);
//             title.append("tspan")
//                 .attr("baseline-shift", "super")
//                 .attr("font-size", 12)
//                 .text(1);
        ...
        function term_on(term) {
            ...
            d3.select(to_select + " .circleGuideTitle")
                .text("Conditional " + selectionLabel + " distribution given " + barUnitSingular + " = '" + term.innerHTML + "'");
        }
        ...
        function term_off(term) {
            ...
            d3.select(to_select + " .circleGuideTitle")
                .text("Marginal " + selectionLabel + " distribution");
